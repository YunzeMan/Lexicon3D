...
if __name__=="__main__":
    ...
    parser.add_argument("--test_file", type=str, help="Test file", default='dataset/sqa3d/SQA3D/ScanQA/data/qa/SQA_test.json')
    ...
    golds = json.load(open(args.test_file))
    ...
    pc_feat_root = args.pc_feat_root
