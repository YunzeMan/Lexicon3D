...
def main(args):
    ...
    logger = TensorBoardLogger("default_root_dir", name=args.dataset)
...
if __name__ == '__main__':
    ...
    # Training Info
    parser.add_argument('--dataset', default='dino_feature', type=str)
    parser.add_argument('--data_dir', default='/scratch/bbsg/yunzem2/dataset/', type=str)
    parser.add_argument('--model_name', default='linear_probe_dino', type=str)
