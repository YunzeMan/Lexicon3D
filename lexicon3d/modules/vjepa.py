...
from vjepautils import PatchEmbed, PatchEmbed3D
from vjepautils import Block
from vjepautils import get_2d_sincos_pos_embed, get_3d_sincos_pos_embed
from vjepautils import trunc_normal_
from vjepautils import apply_masks
...
def build_model():
    model = vit_large(num_frames = 16)

    state_dict = torch.load('vjepa/ckpt/vitl16.pth.tar', map_location=torch.device('cpu'))['encoder']
    matched_state_dict = {}
